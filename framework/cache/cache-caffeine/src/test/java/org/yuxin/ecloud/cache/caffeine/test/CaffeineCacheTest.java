package org.yuxin.ecloud.cache.caffeine.test;

import cn.hutool.core.lang.Assert;
import org.yuxin.ecloud.cache.caffeine.test.config.CaffeineCacheConfig;
import org.yuxin.ecloud.cache.caffeine.test.instance.CacheAnnotationTester;
...
public class CaffeineCacheTest {
    ...
    public void caffeineCacheAnnotationTest() {
        for (int i = 0; i < 2; i++) {
            cacheAnnotationTester.testCacheable("yuxin");
        }
    }
