package org.yuxin.ecloud.web.exception;
...
public class WebExceptionHandler {
    ...
    @ExceptionHandler(value = ECloudBusinessException.class)
    public R eCloudBusinessExceptionHandler(ECloudBusinessException e) {
    ...
    @ExceptionHandler(value = ECloudFrameworkException.class)
    public R eCloudFrameworkExceptionHandler(ECloudFrameworkException e) {
