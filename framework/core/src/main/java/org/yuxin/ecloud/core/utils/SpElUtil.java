...
public class SpElUtil {
    ...
    private static final ECloudExpressionEvaluator expressionEvaluator = new ECloudExpressionEvaluator();
    ...
    @Data
    @AllArgsConstructor
    private static class ECloudExpressionRootObject {
     ...
     */
    @Data
    private static class ECloudExpressionEvaluator extends CachedExpressionEvaluator {
        ...
        private EvaluationContext createEvaluationContext(String className,
            ...
            ECloudExpressionRootObject root = new ECloudExpressionRootObject(className, methodName, classType, method, args, parameterTypes, target);
