package org.yuxin.ecloud.storage.engine.oss.config;
...
@Component
@Data
@ConfigurationProperties(prefix = "org.yuxin.ecloud.storage.engine.oss")
public class OssStorageEngineConfig {
    ...
    public OSSClient ossClient() {
        if (StringUtils.isAnyBlank(getEndpoint(), getAccessKeyId(), getAccessKeySecret(), getBucketName())) {
            throw new ECloudFrameworkException("the oss config is missed!");
        }
