package org.yuxin.ecloud.storage.engine.fd;
...
import org.yuxin.ecloud.storage.engine.fd.config.FastDFSStorageEngineConfig;
...
public class FastDFSStorageEngine extends AbstractStorageEngine {
    ...
    protected void doStoreChunk(StoreFileChunkContext context) throws IOException {
        throw new ECloudFrameworkException("FastDFS不支持分片上传的操作");
    }
    ...
    protected void doReadFile(ReadFileContext context) throws IOException {
        ...
        String group = realPath.substring(ECloudConstants.ZERO_INT, realPath.indexOf(ECloudConstants.SLASH_STR));
        String path = realPath.substring(realPath.indexOf(ECloudConstants.SLASH_STR) + ECloudConstants.ONE_INT);
