package org.yuxin.ecloud.storage.engine.fd.config;
...
@Data
@ConfigurationProperties(prefix = "org.yuxin.ecloud.storage.engine.fdfs")
...
public class FastDFSStorageEngineConfig {
    ...
    public TrackerConnectionManager trackerConnectionManager(FdfsConnectionPool fdfsConnectionPool) {
        ...
        if (CollectionUtils.isEmpty(getTrackerList())) {
            throw new ECloudFrameworkException("the tracker list is empty!");
        }
