package org.yuxin.ecloud.storage.engine.core;
...
public abstract class AbstractStorageEngine implements StorageEngine {
    ...
    protected Cache getCache() {
        if (Objects.isNull(cacheManager)) {
            throw new ECloudFrameworkException("具体的缓存实现需要引用到项目中");
        }
        return cacheManager.getCache(CacheConstants.E_CLOUD_CACHE_NAME);
    }
