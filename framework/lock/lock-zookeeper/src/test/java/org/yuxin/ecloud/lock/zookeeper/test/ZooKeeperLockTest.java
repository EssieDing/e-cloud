package org.yuxin.ecloud.lock.zookeeper.test;

import org.yuxin.ecloud.core.constants.ECloudConstants;
import org.yuxin.ecloud.lock.core.LockConstants;
import org.yuxin.ecloud.lock.zookeeper.test.instance.LockTester;
...
@SpringBootApplication(scanBasePackages = ECloudConstants.BASE_COMPONENT_SCAN_PATH + ".lock")
    ...
    public void lockRegistryTest() throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            threadPoolTaskExecutor.execute(() -> {
                Lock lock = lockRegistry.obtain(LockConstants.E_CLOUD_LOCK);
