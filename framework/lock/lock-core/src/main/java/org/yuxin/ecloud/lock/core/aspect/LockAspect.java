...
public class LockAspect implements ApplicationContextAware {
    ...
    @Pointcut(value = "@annotation(org.yuxin.ecloud.lock.core.annotation.Lock)")
    ...
    public Object aroundLock(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        if (Objects.isNull(lock)) {
            ...
            throw new ECloudFrameworkException("aroundLock get lock fail");
        }
        ...
        try {
            ...
            throw new ECloudFrameworkException("aroundLock tryLock fail.");
        } catch (Throwable e) {
            log.error("lock aspect tryLock exception.", e);
            throw new ECloudFrameworkException("aroundLock tryLock fail.");
        } finally {
