package org.yuxin.ecloud.server.common.stream.consumer.share;
...
public class ShareStatusChangeConsumer extends AbstractConsumer {
     ...
     * @param message
     */
    @StreamListener(ECloudChannels.DELETE_FILE_INPUT)
     ...
     * @param message
     */
    @StreamListener(ECloudChannels.FILE_RESTORE_INPUT)
