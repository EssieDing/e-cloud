package org.yuxin.ecloud.server.modules.file;
...
public class FileTest {
    ...
    public void testQueryUserFileListSuccess() {
        ...
        List<ECloudUserFileVO> result = iUserFileService.getFileList(context);
    ...
    public void testUploadSuccess() {
        ...
        List<ECloudUserFileVO> fileList = iUserFileService.getFileList(queryFileListContext);
    ...
    public void testTransferFileSuccess() {
        ...
        queryFileListContext.setUserId(userId);
        queryFileListContext.setDelFlag(DelFlagEnum.NO.getCode());
        List<ECloudUserFileVO> records = iUserFileService.getFileList(queryFileListContext);
