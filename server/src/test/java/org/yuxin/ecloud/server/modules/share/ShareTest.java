package org.yuxin.ecloud.server.modules.share;

import cn.hutool.core.lang.Assert;
import com.google.common.collect.Lists;
import org.yuxin.ecloud.core.exception.ECloudBusinessException;
import org.yuxin.ecloud.server.ECloudServerLauncher;
...
import org.yuxin.ecloud.server.modules.share.enums.ShareTypeEnum;
...
@SpringBootTest(classes = ECloudServerLauncher.class)
@Transactional
public class ShareTest {
    ...
    public void createShareUrlSuccess() {
        ...
        ECloudShareUrlVO vo = iShareService.create(createShareUrlContext);
    ...
    public void queryShareUrlListSuccess() {
        ...
        List<ECloudShareUrlListVO> result = iShareService.getShares(queryShareListContext);
     ...
     * 校验分享码失败
     */
    @Test(expected = ECloudBusinessException.class)
    ...
    public void queryShareFileListSuccess() {
        ...
        List<ECloudUserFileVO> fileVOList = iShareService.fileList(queryChildFileListContext);
...
//    }
    ...
    private final static String USERNAME = "yuxin";
